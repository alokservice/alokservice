export const siteConfig = {
  ...
  address: {
    street: "105/3, Middle Paickpara",
    city: "Mirpur-10, Dhaka",
    state: "Dhaka",
    zip: "1216",
    country: "Bangladesh",
  },
  social: {
    facebook: "https://facebook.com/alokservice",
    instagram: "https://instagram.com/alokservice",
    twitter: "https://twitter.com/alokservice",
...
export const siteNavigation = {
  ...
  services: [
    { label: "Cleaning Service", href: "/services/cleaning" },
